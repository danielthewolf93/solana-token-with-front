...
export const MintToForm: FC = () => {
  ...
  const mintTo = async (event) => {
    ...
    const mintPubKey = new web3.PublicKey(bs58.decode(event.target.mint.value));
    const recipientPubKey =  new web3.PublicKey(bs58.decode(event.target.recipient.value));
